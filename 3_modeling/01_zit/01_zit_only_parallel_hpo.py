...
Run command (PowerShell on each PC):
  ...
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-004 --enqueue-anchor --n-trials 0

  # Step 2 — open 3 terminals on PC1. Tune --n-jobs so 3 * n_jobs <= physical thread count.
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-004 --worker-id w1 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w1.log 2>&1
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-004 --worker-id w2 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w2.log 2>&1
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-004 --worker-id w3 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w3.log 2>&1

  ### PC2 (hp/005) — identical commands, only --exp-id changes
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-005 --enqueue-anchor --n-trials 0
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-005 --worker-id w1 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w1.log 2>&1
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-005 --worker-id w2 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w2.log 2>&1
  python 3_modeling/01_zit/01_zit_only_parallel_hpo.py --exp-id zit-only-final-005 --worker-id w3 --n-trials 2000 --n-jobs 4 --end-at 2026-06-04T05:00 > w3.log 2>&1
...
def main() -> None:
    ...
    out_dir = Path(OUTPUT_DIR) / "01_zit" / "zit_only" / args.exp_id.split("-")[-1]
