...
Run command (PowerShell). PC1->v3, PC2->v4, PC3->v5. Deadline 2026-06-08 05:00.
  ...
  python 3_modeling/01_zit/02_bag_zit_eql_mmap_parallel_hpo.py --variant v3 --enqueue-anchor --n-trials 0
  ...
  python 3_modeling/01_zit/02_bag_zit_eql_mmap_parallel_hpo.py --variant v3 --worker-id w1 --n-trials 100000 --n-jobs 2 --end-at 2026-06-08T05:00 > 4_output/logs/eql_v3_w1.log 2>&1
