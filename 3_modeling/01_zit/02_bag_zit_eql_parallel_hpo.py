...
Run command (PowerShell):
  ...
  python 3_modeling/01_zit/02_bag_zit_eql_parallel_hpo.py --enqueue-anchor --n-trials 0

  # Open 3 terminals. Tune --n-jobs so 3 * n_jobs <= physical thread count.
  python 3_modeling/01_zit/02_bag_zit_eql_parallel_hpo.py --worker-id w1 --n-trials 2000 --n-jobs 4 --n-startup-trials 12 --end-at 2026-06-01T09:00 > bag_eql_w1.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_eql_parallel_hpo.py --worker-id w2 --n-trials 2000 --n-jobs 4 --n-startup-trials 12 --end-at 2026-06-01T09:00 > bag_eql_w2.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_eql_parallel_hpo.py --worker-id w3 --n-trials 2000 --n-jobs 4 --n-startup-trials 12 --end-at 2026-06-01T09:00 > bag_eql_w3.log 2>&1
