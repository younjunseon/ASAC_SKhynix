...
Run command (PowerShell) -- 6 workers on one machine, n_jobs=3 each (6 * 3 = 18 threads):
  ...
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --enqueue-anchor --n-trials 0

  # Open 6 terminals. Only --worker-id changes; pass the same --end-at to all.
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w1 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w1.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w2 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w2.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w3 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w3.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w4 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w4.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w5 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w5.log 2>&1
  python 3_modeling/01_zit/02_bag_zit_parallel_hpo.py --worker-id w6 --n-trials 2000 --n-jobs 3 --n-startup-trials 12 --end-at 2026-06-02T09:00 > bag_w6.log 2>&1
