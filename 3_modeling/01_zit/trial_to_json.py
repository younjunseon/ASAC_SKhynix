...
사용 (CLI):
  python 3_modeling/01_zit/trial_to_json.py \
      --db 4_output/01_zit/bag_zit/002/optuna_jh_bag-zit-eql-final-002.db \
      --trial 82 \
      --out 4_output/01_zit/bag_zit/_custom/eql_002_t82/best_params.json
