...
DEFAULT_PARAMS = {
    ...
    "missing_threshold":          0.30,          # 결측률 ≥ 이 값 → 제거 (strategy_common §1)
    ...
    "spatial_max_dist":           6.0,           # spatial 보간 거리 (strategy_common §1)
    "post_impute_corr_threshold": 0.96,          # 2차 |r| 제거 임계값 (strategy_common §1)
